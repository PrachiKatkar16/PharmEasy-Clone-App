...
const Carousel = () => {
  ...
  return (
    <Box marginLeft="80px" marginRight="80px" position="relative" mt={"70px"} mb={"80px"}> {/* Adjust margins as needed */}
      <Heading as="h2" size="lg" mb={2} fontFamily={"sans-serif"}>Previously Browsed Items</Heading>
      <Slider {...settings}>
