...
const Carousel = () => {
  ...
  return (
    <Box marginLeft="80px" marginRight="80px" position="relative" mt={"80px"} mb={"80px"}> {/* Adjust margins as needed */}
      <Heading as="h2" size="lg" mb={2} fontFamily={"sans-serif"}>Trending Near You</Heading>
      <Text mb={4}>Popular in your city</Text>
      <Slider {...settings}>
        {Data.trending.map((el, index) => (
          <Box
            key={index}
            p={1}
